                            ...
                            <tbody>
                                @forelse ($cycles as $index => $cycle)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('billing-cycles.edit', $cycle->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                            <form action="{{ route('billing-cycles.destroy', $cycle->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure?')">
                                                @csrf
                                                @method('DELETE')
